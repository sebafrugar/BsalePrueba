...
fetch('http://localhost:8000/api/prueba')
    .then((response) =>{
        ...
        const filtrar = response.productos.filter(filtro => filtro.category === 7);
        console.log(filtrar)
        document.getElementById("producto").innerHTML = response.productos.filter(filtro => filtro.category === 7).map(producto => `
...
let porNombre = () => {
    ...
    .then((response) =>{
        ...
        document.getElementById("producto").innerHTML = filtroAZ.filter(filtro => filtro.category === 7).map(producto => `
            <div class="card d-inline-block m-2" style="width: 17rem ;">
                <div class="card-header rounded text-center d-block">
                    <img src="${producto.url_image}" alt="imagen producto" srcset="" style="width: 100px; height: 150px ;align-middle;">
                </div>
...
let porPrecioMenorMayor = () => {
    ...
    .then((response) =>{
        ...
        document.getElementById("producto").innerHTML = filtroPrecioMenorMayor.filter(filtro => filtro.category === 7).map(producto => `
            <div class="card d-inline-block m-2" style="width: 17rem ;">
                <div class="card-header rounded text-center d-block">
                    <img src="${producto.url_image}" alt="imagen producto" srcset="" style="width: 100px; height: 150px ;align-middle;">
                </div>
...
let porPrecioMayorMenor = () => {
    ...
    .then((response) =>{
        ...
        document.getElementById("producto").innerHTML = filtroPrecioMayorMenor.filter(filtro => filtro.category === 7).map(producto => `
            <div class="card d-inline-block m-2" style="width: 17rem ;">
                <div class="card-header rounded text-center d-block">
                    <img src="${producto.url_image}" alt="imagen producto" srcset="" style="width: 100px; height: 150px ;align-middle;">
                </div>
...
let porStock = () => {
    ...
    .then((response) =>{
        ...
        document.getElementById("producto").innerHTML = filtroStock.filter(filtro => filtro.category === 7).map(producto => `
            <div class="card d-inline-block m-2" style="width: 17rem ;">
                <div class="card-header rounded text-center d-block">
                    <img src="${producto.url_image}" alt="imagen producto" srcset="" style="width: 100px; height: 150px ;align-middle;">
                </div>
